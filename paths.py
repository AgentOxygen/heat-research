...
def get_paths_thresholds() -> tuple:
    ...
    threshold_xaer_datasets = [POST_HEAT_THRESHOLDS_1920_TO_1950 + name for name in dataset_names if 'XAER' in name]
    threshold_xghg_datasets = [POST_HEAT_THRESHOLDS_1920_TO_1950 + name for name in dataset_names if 'XGHG' in name]
    threshold_all_datasets = [POST_HEAT_THRESHOLDS_1920_TO_1950 + name for name in dataset_names if 'ALL' in name]
...
def get_paths_split_heat_output(tmp_type: str = "tn") -> tuple:
    ...
    """
    dir_path = POST_HEAT_OUTPUT_1920_1950_BASE + "split/"
...
def get_paths_trefht_odata() -> tuple:
    ...
    # em -> ensemble members
    trefht_all_former_em = [DOWNLOADED_ODATA_DIR + name for name in all_datasets if '.TREFHT.19200101-20051231' in name]
    trefht_xaer_former_em = [DOWNLOADED_ODATA_DIR + name for name in xaer_datasets if '.TREFHT.19200101-20051231' in name]
    trefht_xghg_former_em = [DOWNLOADED_ODATA_DIR + name for name in xghg_datasets if '.TREFHT.19200101-20051231' in name]
    trefht_all_latter_em = [DOWNLOADED_ODATA_DIR + name for name in all_datasets if '.TREFHT.20060101-20801231' in name]
    trefht_xaer_latter_em = [DOWNLOADED_ODATA_DIR + name for name in xaer_datasets if '.TREFHT.20060101-20801231' in name]
    trefht_xghg_latter_em = [DOWNLOADED_ODATA_DIR + name for name in xghg_datasets if '.TREFHT.20060101-20801231' in name]
...
def get_paths_trefhtmin_odata() -> tuple:
    ...
    trefhtmin_all_former_em = [DOWNLOADED_ODATA_DIR + name for name in all_datasets if '.TREFHTMN.19200101-20051231' in name]
    trefhtmin_xaer_former_em = [DOWNLOADED_ODATA_DIR + name for name in xaer_datasets if '.TREFHTMN.19200101-20051231' in name]
    trefhtmin_xghg_former_em = [DOWNLOADED_ODATA_DIR + name for name in xghg_datasets if '.TREFHTMN.19200101-20051231' in name]
    trefhtmin_all_latter_em = [DOWNLOADED_ODATA_DIR + name for name in all_datasets if '.TREFHTMN.20060101-20801231' in name]
    trefhtmin_xaer_latter_em = [DOWNLOADED_ODATA_DIR + name for name in xaer_datasets if '.TREFHTMN.20060101-20801231' in name]
    trefhtmin_xghg_latter_em = [DOWNLOADED_ODATA_DIR + name for name in xghg_datasets if '.TREFHTMN.20060101-20801231' in name]
...
def get_paths_trefhtmax_odata() -> tuple:
    ...
    trefhtmax_all_former_em = [DOWNLOADED_ODATA_DIR + name for name in all_datasets if '.TREFHTMX.19200101-20051231' in name]
    trefhtmax_xaer_former_em = [DOWNLOADED_ODATA_DIR + name for name in xaer_datasets if '.TREFHTMX.19200101-20051231' in name]
    trefhtmax_xghg_former_em = [DOWNLOADED_ODATA_DIR + name for name in xghg_datasets if '.TREFHTMX.19200101-20051231' in name]
    trefhtmax_all_latter_em = [DOWNLOADED_ODATA_DIR + name for name in all_datasets if '.TREFHTMX.20060101-20801231' in name]
    trefhtmax_xaer_latter_em = [DOWNLOADED_ODATA_DIR + name for name in xaer_datasets if '.TREFHTMX.20060101-20801231' in name]
    trefhtmax_xghg_latter_em = [DOWNLOADED_ODATA_DIR + name for name in xghg_datasets if '.TREFHTMX.20060101-20801231' in name]
...
def get_paths_heat_output(tmp_type: str = "tn") -> tuple:
    pass
...
def get_paths_cdata() -> tuple:
    ...
    trefht_all_em = [CONCATENATED_DATA + name for name in datasets if "trefht_all" in name]
    trefht_xaer_em = [CONCATENATED_DATA + name for name in datasets if "trefht_xaer" in name]
    trefht_xghg_em = [CONCATENATED_DATA + name for name in datasets if "trefht_xghg" in name]
    trefhtmax_all_em = [CONCATENATED_DATA + name for name in datasets if "trefhtmax_all" in name]
    trefhtmax_xaer_em = [CONCATENATED_DATA + name for name in datasets if "trefhtmax_xaer" in name]
    trefhtmax_xghg_em = [CONCATENATED_DATA + name for name in datasets if "trefhtmax_xghg" in name]
    trefhtmin_all_em = [CONCATENATED_DATA + name for name in datasets if "trefhtmin_all" in name]
    trefhtmin_xaer_em = [CONCATENATED_DATA + name for name in datasets if "trefhtmin_xaer" in name]
    trefhtmin_xghg_em = [CONCATENATED_DATA + name for name in datasets if "trefhtmin_xghg" in name]
