...
from paths import HEAT_OUTPUT_1920_1950_BASE, HEAT_THRESHOLDS_1920_TO_1950, DOWNLOADED_ODATA_DIR, \
    ...
    OUT_ALL_AVGS_1980_2000, OUT_EM_AVGS_1920_1950, MERRA2_DATA
import xarray
import numpy as np
...
def process_merra2() -> None:
    max_ds_path = "/projects/dgs/persad_research/heat_research/MERRA2_data/MERRA2_t2max.nc"
    min_ds_path = "/projects/dgs/persad_research/heat_research/MERRA2_data/MERRA2_t2min.nc"
    th_path = "/projects/dgs/persad_research/heat_research/MERRA2_data/threshold_1980-2010_90pcntl.nc"
    system(f'python3 ehfheatwaves_compound_inputthres_3.py -x {max_ds_path} -n {min_ds_path} --change_dir {MERRA2_DATA}' + f'- --thres {th_path} --base=1980-2000 -d CESM2 --vnamex T2MMAX --vnamen T2MMIN')
